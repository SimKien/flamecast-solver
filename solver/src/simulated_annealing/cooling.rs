...
impl CoolingSchedule {
    pub fn get_temperature(&self, initial_temperature: f64, iteration: usize) -> f64 {
        match self {
            CoolingSchedule::Exponential(alpha) => initial_temperature * alpha.powi(iteration as i32),
            ...
            CoolingSchedule::Logarithmic(alpha) => initial_temperature / (1.0 + alpha * (1.0 + iteration as f64).ln()),
        }
    }
}